...
public class CountMinSketch // implements IFrequency
{
    ...
    private void initTablesWith(int depth, int width, long seed)
    {
    ...
    {
    	return (MurmurHash.hash(item.getBytes(), width, hashA[i]));
    }
